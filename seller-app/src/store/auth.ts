...
const ACCESS_TOKEN_KEY = 'fm_seller_access_token';
const REFRESH_TOKEN_KEY = 'fm_seller_refresh_token';
const USER_PHONE_KEY = 'fm_seller_phone';
const USER_ROLE_KEY = 'fm_seller_role';
