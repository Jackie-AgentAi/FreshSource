...
import * as Plugin_0 from 'D:/AI/codex/FreshSource/admin-web/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/AI/codex/FreshSource/admin-web/src/app.tsx',
    },
    {
      apply: Plugin_1,
